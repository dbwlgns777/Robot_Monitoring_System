...
export function AppLayout()
{
 ...
 function logout(){localStorage.removeItem('prima-auth');localStorage.removeItem('prima-user');sessionStorage.removeItem('prima-auth');sessionStorage.removeItem('prima-user');void authApi.logout().finally(()=>nav('/login'))}
